...
// Route::get('/user_singup',  'AppointmentController@store1');
// Route::post('user_singup', 'PatientController@store1')->name('user_singup.store1');
// Route::get('patients', 'PatientController@index')->name('patients.index');
Route::post('patients', 'PatientController@store')->name('patients.store');
Route::get('/plaid-verification', 'DocumentController@plaidVerification')->name('plaid-verification');
Route::get('/createLinkToken', 'PlaidController@createLinkToken')->name('createLinkToken');
Route::post('/storePlaidAccount', 'PlaidController@storePlaidAccount');
Route::get('/CoApplicant', 'CoApplicantController@show')->name('CoApplicant');
Route::post('/getInvestmentHoldings', 'PlaidController@getInvestmentHoldings');
//send inivtation link
Route::post('/coApplicant', 'CoApplicantController@store')->name('coApplicant');
...
Route::get('appointment-doctor-schedule-list', 'ScheduleController@doctorScheduleList')->name('front-doctor-schedule-list');
...
Route::group([
    ...
    function () {
        ...
        Route::get('stripe-payment-success', 'StripeController@paymentSuccess')->name('stripe-payment-success');
...
//                    Route::get('notice-board', 'NoticeBoardController@index')->name('noticeboard')->middleware('modules');
                    Route::get('notice-board', 'NoticeBoardController@index')->name('employee-noticeboard');
        ...
        Route::group(['middleware' => ['role:Admin|Patient|Doctor', 'check_menu_access']], function () {
            Route::resource('documents', 'DocumentController')->except('update');
        ...
        Route::group(['middleware' => ['role:Admin|Patient|Doctor|Receptionist']], function () {
            ...
            Route::group(['prefix' => 'patient', 'namespace' => 'Patient'], function () {
                ...
                Route::get('my-prescriptions/{id}', 'PrescriptionController@show')->name('patient.prescriptions.show');
            });
        });
        ...
        Route::group(['middleware' => ['role:Admin|Receptionist|Case Manager']], function () {
            ...
            // Route::get('building-user', 'PatientController@index')->name('patients.index')->middleware('modules');
            // Route::post('patients', 'PatientController@store')->name('patients.store');
        ...
        Route::group(['middleware' => ['role:Admin|Patient']], function () {
            Route::group(['prefix' => 'employee', 'namespace' => 'Employee'], function () {
                ...
                Route::get('invoices/{invoice}/pdf', 'InvoiceController@convertToPdf')
                    ->where('invoice', '[0-9]+');
                Route::get('bills', 'BillController@index')->name('bill.index');
//            Route::get('bills', 'BillController@index')->name('bills.index')->middleware('modules');
        ...
        Route::group(['middleware' => ['role:Admin|Doctor']], function () {
            ...
            Route::get('prescription-medicine-show/{id}', 'PrescriptionController@prescriptionMedicineShowFunction')->name('prescription.medicine.show');
        ...
        Route::group(['middleware' => ['role:Admin|Receptionist|Case Manager']], function () {
            ...
            Route::post('ambulances/{ambulance_id}', 'AmbulanceController@destroy')->name('ambulance.destroy');
...
//        Route::resource('departments', 'DepartmentController');
            ...
            Route::post('users/{user}/active-deactive',
                'UserController@activeDeactiveUserStatus')->name('hospital.users.status');
            ...
            Route::post('front-settings',
                'FrontSettingController@update')->name('front.settings.update')->withoutMiddleware('xss');
            Route::get('incomeverify', 'IncomeverificationController@Incomeverifycall')->name('incomeverify');
            Route::get('idverifications', 'IdVerificationsController@idverifications')->name('idverifications');
...
Route::group([
    ...
    Route::post('hospitals/{id}/is-verified', 'UserController@isVerified')->name('hospital.users.verified');
    Route::post('hospitals/{id}/active-deactive', 'UserController@activeDeactiveStatus')->name('users.status');

    // Route::get('building', 'UserController@index')->name('super.admin.hospitals.index');
    ...
    Route::resource('super-admin-currency-settings', 'SuperAdminCurrencySettingController');
    ...
    //Notification routes
    Route::get('/notification/{notification}/read',
        'NotificationController@readNotification')->name('admin.read.notification');
    Route::post('/read-all-notification',
        'NotificationController@readAllNotification')->name('admin.read.all.notification');
