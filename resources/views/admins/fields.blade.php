<div class="row">
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('first_name', null, ['class' => 'form-control','required','placeholder' => __('Enter First Name')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::text('last_name', null, ['class' => 'form-control','required','placeholder' => __('Enter Last Name')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::password('password_confirmation', ['class' => 'form-control','required','placeholder' => __('Enter Confirm Password'),'min' => '6','max' => '10']) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
