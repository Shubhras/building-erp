                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card p-5 ms-md-2">
                                <div class="card-header px-0">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="text-primary mb-1 me-0 header-link">New Plan</span>
                                    </h3>
                                </div>
                                <div class="card-body py-3 px-0">
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Plan Name</h4>
                                        <span class="text-muted mt-1 sub-heading">{{$newPlan['name']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Plan Price</h4>
                                        <span class="text-muted  mt-1">
                                        <span class="mb-2 sub-heading">
                                    ...
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Start Date</h4>
                                        <span class="text-muted mt-1 sub-heading">{{$newPlan['startDate']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">End Date</h4>
                                        <span class="text-muted mt-1 sub-heading">{{$newPlan['endDate']}}</span>
                                    </div>
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Total Days</h4>
                                        <span class="text-muted  mt-1 sub-heading">{{$newPlan['totalDays']}} Days</span>
                                    </div>
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Remaining Balance of
                                            Prev. Plan</h4>
                                        <span class="text-muted  mt-1 sub-heading">
                                        {{ getAdminCurrencySymbol($subscriptionsPricingPlan->currency) }}
                                            {{$newPlan['remainingBalance']}}
                                    </span>
                                    </div>
                                    <div class="d-flex align-items-center plan-border-bottom py-2">
                                        <h4 class="plan-data mb-0 me-5 table-font">Payable Amount</h4>
                                        <span class="text-muted mt-1 sub-heading">
                                        {{ getAdminCurrencySymbol($subscriptionsPricingPlan->currency) }}
                                            {{$newPlan['amountToPay']}}
                                    </span>
