...
{{--<div class="row">
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <h4 class="mt-2 table-font">{{ __('messages.subscription_plans.plan_features') }}</h4>  
    </div>
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <label class="form-check form-switch form-check-custom form-check-solid float-end">
            ...
            <span class="form-check-label sub-heading">{{ __('messages.subscription_plans.select_all') }}</span>
        </label>
    </div>
</div>--}}
    ...
    @foreach($planFeatures as $planFeature)
        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 mb-5">
            <label class="form-check form-switch form-check-custom">
                ...
                <span class="form-check-label sub-heading">{{ $planFeature->name }}</span>&nbsp;&nbsp;
