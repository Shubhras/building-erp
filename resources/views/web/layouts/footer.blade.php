...
<footer class="footer" style="background-color: #0a2843;">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-4 mb-lg-0 mb-4">
                <div class="row justify-content-between">
                    <div class="col-lg-2 mb-lg-0 mb-4" style="width: 200px; padding: 0px 0px 25px 6px;">
                        <img src="{{ asset(getLogoUrl()) }}" alt="Infy HMS" class="img-fluid"/>
                    </div>
                    <div class="col-lg-10" style="width:100%">
                        <p class="d-block text-white footer-font">
