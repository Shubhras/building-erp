...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('dashboard*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('dashboard*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('users*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('users*') ? 'active' : ''  }}"
       href="{{ route('users.index') }}">{{ __('messages.users') }}</a>
</li>
@endrole

<!-- <li class="nav-item  {{ Request::is('CoApplicant*') ? 'active' : '' }}">
    <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('CoApplicant') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa-circle-user"></i></span>
        <span class="aside-menu-title">Co-Applicants</span>
    </a> 
</li> -->
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('subscription-plans*') && !Request::is('choose-payment-type*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('subscription-plans*') || Request::is('choose-payment-type*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('vaccinated-patients*','vaccinations*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('vaccinations*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('accounts*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee-payrolls*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('invoices*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('payments*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('payment-reports*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('advanced-payments*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accounts*','employee-payrolls*','invoices*','payments*','payment-reports*','advanced-payments*','bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('bills*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('bed-types*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ (Request::is('beds*') || Request::is('bulk-beds')) ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('bed-types*','beds*','bed-assigns*','bulk-beds','bed-status')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('bed-assigns*','bed-status') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('blood-banks*','blood-donors*','blood-donations*','blood-issues*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('blood-banks*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('blood-banks*','blood-donors*','blood-donations*','blood-issues*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('blood-donors*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('blood-banks*','blood-donors*','blood-donations*','blood-issues*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('blood-donations*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('blood-banks*','blood-donors*','blood-donations*','blood-issues*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('blood-issues*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patients*') ? 'active' : '' }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient-cases*') ? 'active' : '' }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('case-handlers*') ? 'active' : '' }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient-admissions*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/doctor*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/doctor*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/prescriptions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/prescriptions*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('documents*','document-types*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('documents*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('documents*','document-types*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('document-types*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('insurances*','packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('insurances*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('insurances*','packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('packages*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('insurances*','packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('services*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('insurances*','packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('ambulances*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('insurances*','packages*','services*','ambulances*','ambulance-calls*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('ambulance-calls*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*','prescriptions*, prescription-medicine-show*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('doctors*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*','prescriptions*','prescription-medicine-show*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('doctor-departments*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*','prescriptions*', 'prescription-medicine-show*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('schedules*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('doctors*','doctor-departments*','schedules*','prescriptions*', 'prescription-medicine-show*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('prescriptions*', 'prescription-medicine-show*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('accountants*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('accountants*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('nurses*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('nurses*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('receptionists*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('receptionists*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('lab-technicians*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('lab-technicians*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('pharmacists*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('pharmacists*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('appointments*','appointment-calendars')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('appointments*','appointment-calendars') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('birth-reports*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('death-reports*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('investigation-reports*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('birth-reports*','death-reports*','investigation-reports*','operation-reports*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('operation-reports*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('brands*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('categories*','brands*','medicines*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('medicines*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('radiology-categories*','radiology-tests*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('radiology-categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('radiology-categories*','radiology-tests*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('radiology-tests*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('pathology-categories*','pathology-tests*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('pathology-categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('pathology-categories*','pathology-tests*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('pathology-tests*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('diagnosis-categories*','patient-diagnosis-test*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('diagnosis-categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('diagnosis-categories*','patient-diagnosis-test*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient-diagnosis-test*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('sms*','mail*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('sms*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('sms*','mail*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('mail*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('incomes*','expenses*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('incomes*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('incomes*','expenses*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('expenses*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('item-categories*','items*','item-stocks*','issued-items*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('item-categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('item-categories*','items*','item-stocks*','issued-items*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('items*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('item-categories*','items*','item-stocks*','issued-items*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('item-stocks*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('item-categories*','items*','item-stocks*','issued-items*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('issued-items*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('charge-categories*','charges*','doctor-opd-charges*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('charge-categories*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('charge-categories*','charges*','doctor-opd-charges*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('charges*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('charge-categories*','charges*','doctor-opd-charges*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('doctor-opd-charges*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('call-logs*','visitor*','receives*','dispatches*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('call-logs*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('call-logs*','visitor*','receives*','dispatches*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('visitor*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('call-logs*','visitor*','receives*','dispatches*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('receives*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('call-logs*','visitor*','receives*','dispatches*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 header-link {{ Request::is('dispatches*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('live-consultation*','live-meeting*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 header-link {{ Request::is('live-consultation*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('live-consultation*','live-meeting*')) ? 'd-none' : '' }}">
    <a class="nav-link p-0 header-link {{ Request::is('live-meeting*') ? 'active' : '' }}"
       href="{{ route('live.meeting.index') }}">{{ __('messages.live_meetings') }}</a>
</li>
@endmodule
@endrole
 
@php($sectionName = (Request::get('section') === null && !Request::is('currency-settings*','hospital-schedules','payment_gateway*')) ?  'general' : Request::get('section'))
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
    <a class="nav-link header-link p-0 {{ (isset($sectionName) && $sectionName == 'general') ? 'active' : '' }}"
       href="{{ route('settings.edit', ['section' => 'general']) }}">{{ __('messages.general') }}</a>
</li>

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
    <a class="nav-link header-link p-0 {{ Request::is('hospital-schedules*') ? 'active' : ''  }}"
       href="{{ route('hospital-schedules.index') }}">{{ __('messages.hospital_schedules') }}</a>
</li>--}}

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
    <a class="nav-link header-link p-0 {{ (isset($sectionName) && $sectionName == 'sidebar-setting') ? 'active' : '' }}"
       href="{{ route('settings.edit', ['section' => 'sidebar-setting']) }}">{{ __('messages.sidebar_setting') }}</a>
</li>--}}

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
    <a class="nav-link header-link p-0 {{ Request::is('payment-gateway*') ? 'active' : ''  }}"
       href="{{ route('payment-gateway.index') }}">{{ __('messages.setting.payment_gateway') }}</a>
</li>--}}

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (Request::is('currency-settings*','settings*','payment-gateway*','hospital-schedules')) ? '' : 'd-none' }}">
    <a class="nav-link header-link p-0 {{ Request::is('currency-settings*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('front-settings*','notice-boards*','testimonials*', 'front-cms-services*','terms-and-conditions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('front-settings*') ? 'active' : ''  }}"
       href="{{ route('front.settings.index') }}">{{ __('messages.cms') }}</a>
</li>

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('front-settings*','notice-boards*','testimonials*', 'front-cms-services*','terms-and-conditions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('front-cms-services*') ? 'active' : ''  }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('front-settings*','notice-boards*','testimonials*', 'front-cms-services*','terms-and-conditions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('notice-boards*') ? 'active' : '' }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('front-settings*','notice-boards*','testimonials*', 'front-cms-services*','terms-and-conditions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('testimonials*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('enquiries*','enquiry*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('enquiries*') || Request::is('enquiry*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/doctor*','prescriptions*','schedules*','doctors*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/doctor*','doctors*') ? 'active' : ''  }}"
       href="{{ url('employee/doctor') }}">{{ __('messages.doctors') }}</a>
</li>
@endmodule
@module('Schedules',$modules)
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/doctor*','prescriptions*','schedules*','doctors*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('prescriptions*') ? 'active' : '' }}"
       href="{{ route('prescriptions.index') }}">{{ __('messages.prescriptions') }}</a>
</li>
@endmodule
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/notice-board*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/notice-board*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/payroll*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/payroll*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient/my-cases*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient/my-cases*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/patient-admissions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/patient-admissions*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient/my-prescriptions*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient/my-prescriptions*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient/my-vaccinated*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient/my-vaccinated*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient/my-ipds*','opds*','patient/my-opds*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('patient/my-ipds*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('patient/my-ipds*','opds*','patient/my-opds*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('opds*','patient/my-opds*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/patient-diagnosis-test*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/patient-diagnosis-test*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/invoices*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/invoices*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('employee/bills*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('employee/bills*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/dashboard*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/dashboard*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/admins*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/admins*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/hospitals*', 'super-admin/hospital*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/hospitals*', 'super-admin/hospital*') ? 'active' : ''  }}"
       href="{{ route('super.admin.hospitals.index') }}">{{ __('Building') }}</a>
</li>
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/subscription-plans*', 'super-admin/transactions*', 'super-admin/subscriptions-hospitals*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/subscription-plans*') ? 'active' : ''  }}"
       href="{{ route('super.admin.subscription.plans.index') }}">{{ __('messages.subscription_plans.subscription_plans') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/subscription-plans*', 'super-admin/transactions*', 'super-admin/subscriptions-hospitals*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/transactions*') ? 'active' : '' }}"
       href="{{ route('subscriptions.transactions.index') }}">{{ __('messages.subscription_plans.transactions') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/subscription-plans*', 'super-admin/transactions*', 'super-admin/subscriptions-hospitals*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/subscriptions-hospitals*') ? 'active' : '' }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/section-one*') ? 'active' : ''  }}"
       href="{{ route('super.admin.section.one') }}">{{ __('messages.landing_cms.section_one') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/section-two*') ? 'active' : ''  }}"
       href="{{ route('super.admin.section.two') }}">{{ __('messages.landing_cms.section_two') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/section-three*') ? 'active' : ''  }}"
       href="{{ route('super.admin.section.three') }}">{{ __('messages.landing_cms.section_three') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/section-four*') ? 'active' : ''  }}"
       href="{{ route('super.admin.section.four') }}">{{ __('messages.landing_cms.section_four') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/section-five*') ? 'active' : ''  }}"
       href="{{ route('super.admin.section.five') }}">{{ __('messages.landing_cms.section_five') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/about-us*') ? 'active' : ''  }}"
       href="{{ route('super.admin.about.us') }}">{{ __('messages.landing_cms.about_us') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/service-slider*') ? 'active' : ''  }}"
       href="{{ route('service-slider.index') }}">{{ __('messages.web_home.services') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/faqs*') ? 'active' : ''  }}"
       href="{{ route('faqs.index') }}">{{ __('messages.faqs.faqs') }}</a>
</li>

<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/section-one*','super-admin/section-two*','super-admin/section-three*','super-admin/section-four*','super-admin/section-five*','super-admin/about-us*','super-admin/service-slider*','super-admin/faqs*','super-admin/admin-testimonial*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/admin-testimonial') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/footer-settings*','super-admin/super-admin-currency-settings*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link header-link p-0 {{ Request::is('super-admin/general-settings*') ? 'active' : ''  }}"
       href="{{ route('super.admin.settings.edit') }}">{{ __('messages.settings') }} </a>
</li>

{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/footer-settings*','super-admin/super-admin-currency-settings*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link header-text p-0 {{ Request::is('super-admin/footer-settings*') ? 'active' : ''  }}"
...
{{--<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/general-settings*','super-admin/super-admin-currency-settings*','super-admin/footer-settings*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/super-admin-currency-settings*') ? 'active' : ''  }}"
...
<li class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ (!Request::is('super-admin/enquiries*')) ? 'd-none' : '' }}">
    <a class="nav-link header-link p-0 {{ Request::is('super-admin/enquiries*') ? 'active' : ''  }}"
