...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('accountants.index') }}">
...
<li class="nav-item {{ Request::is('super_id_verification*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3 " aria-current="page" href="{{ route('idverifications') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa fa-clock"></i></span>
        <span class="aside-menu-title">{{ __('messages.dashboard.id_verification') }}</span>
    </a>
</li>
<li class="nav-item {{ Request::is('super_income_verification*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3 " aria-current="page" href="{{ route('incomeverify') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa fa-user"></i></span>
        <span class="aside-menu-title">{{ __('messages.dashboard.income_verification') }}</span>
    </a>
</li>

{{-- Settings --}}
<li
    class="nav-item  {{ Request::is('currency-settings*','settings*','hospital-schedules', 'payment-gateway*') ? 'active' : '' }}">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('lab-technicians.index') }}">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('nurses.index') }}">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('pharmacists.index') }}">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('receptionists.index') }}">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ $smsMailMgt }}" title="{{ __('messages.sms.sms_mail') }}">
    <span class="aside-menu-icon pe-3">
...
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('subscriptions.plans.transactions.index') }}">
    <span class="aside-menu-icon pe-3">
...
{{-- @if ($frontReceptionistOfficeMGT)
        <li class="nav-item {{ Request::is('call-logs*','visitor*','receives*','dispatches*') ? 'active' : '' }}">
<a class="nav-link  d-flex align-items-center py-3 " href="{{ $frontReceptionistOfficeMGT }}">patients
    <span class="aside-menu-icon pe-3"><i class="fa fa-dungeon"></i></span>
    <span class="aside-menu-title">{{ __('messages.front_office') }}</span>
    <span class="d-none">{{ __('messages.call_logs') }}</span>
    <span class="d-none">{{ __('messages.visitors') }}</span>
...
<?php
    ...
    ?>
<!-- {{ Request::is('super-admin/dashboard*') ? 'activess' : '' }}" 
{{ Request::is('dashboard*','front-settings*','settings*','users*') ? 'active' : 'activess' }}"-->
@role('Admin')
@if ($receptionistPatientCaseMgt)
<li
    class="nav-item {{ Request::is('patients*','patient-cases*','case-handlers*','patient-admissions*','documents') ? 'active' : '' }}">
...
{{--@else($receptionistPatientCaseMgt!='super-admin/dashboard*')
        <li class="nav-item {{ Request::is('super-admin/dashboard*','super-admin/admins','super-admin/hospitals','super-admin/subscription-plans','super-admin/general-settings','documents') ? 'activess' : '' }}">
<a class="nav-link  d-flex align-items-center py-3 " href="{{ $receptionistPatientCaseMgt }}">
    <span class="aside-menu-icon pe-3"><i class="fas fa-user-injured"></i></span>
    <span class="aside-menu-title">{{ __('messages.patients') }}</span>
    <span class="d-none">{{__('messages.cases')}}</span>
...
@module('Documents',$modules)
@if(isFeatureAllowToUse('documents.index'))
<li class="nav-item  {{ Request::is('documents*') ? 'active' : 'activess' }}">
    <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('documents.index') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa-file"></i></span>
        <span class="aside-menu-title">{{ __('messages.documents') }}</span>
    </a>
...
<li class="nav-item {{ Request::is('super-admin/admins*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3 " aria-current="page" href="{{ route('admins.index') }}">
        ...
        <span class="aside-menu-title side-menu-set">{{ __('messages.admins') }}</span>
    </a>
</li>

{{-- Super Admin Users --}}
<li class="nav-item {{ Request::is('super-admin/hospitals*','super-admin/hospital*') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
        href="{{ route('super.admin.hospitals.index') }}">
        <span class="aside-menu-icon pe-3"><i class="fa-sharp fa-solid fa-building"></i></span>
        <span class="aside-menu-title side-menu-set">{{ __('Building') }}</span>
    </a>
</li>
{{-- Front settings --}}
{{--<li class="nav-item  {{ Request::is('front-settings*','notice-boards*','testimonials*', 'front-cms-services*') ? 'active' : '' }}">
<a class="nav-link  d-flex align-items-center py-3 " href="{{ route('front.settings.index') }}">
    <span class="aside-menu-icon pe-3"><i class="fas fa fa-cog"></i></span>
    <span class="aside-menu-title side-menu-set">{{ __('messages.front_cms') }}</span>
    <span class="d-none">{{ __('messages.notice_boards') }}</span>
    <span class="d-none">{{ __('messages.testimonials') }}</span>
    <span class="d-none">{{ __('messages.cms') }}</span>
    <span class="d-none">{{ __('messages.front_cms_services') }}</span>
...
<li
    ...
    <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
        ...
        <span class="aside-menu-title side-menu-set">{{ __('messages.billings') }}</span>
    </a>
</li>
<li
    class="nav-item  {{ Request::is('super-admin/general-settings*','super-admin/footer-settings*','super-admin/super-admin-currency-settings*') ? 'active' : '' }}">
