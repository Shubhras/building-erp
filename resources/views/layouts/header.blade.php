    ...
    <ul class="nav align-items-center flex-nowrap">
        ...
        <li class="px-xxl-3 px-2">
            <div class="dropdown dropdown-transparent d-flex align-items-center py-4">
                ...
                <button class="btn header-link  dropdown-toggle ps-2 pe-0 text-gray-600" type="button" id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                    {{ (Auth::user()->full_name)??'' }}
                    <i class="fa-solid fa-angle-down"></i>
                </button>
                <div class="dropdown-menu py-7 pb-4 my-2 dropdown-head" aria-labelledby="dropdownMenuButton1">
                    <div class="text-center border-bottom pb-5">
                        ...
                        <div class="head-area">
                        <h3 class="text-gray-900" style="font-size:20px; font-weight:700; color:#0c266c;">{{ (Auth::user()->full_name)??'' }}</h3>
                        <h4 class="mb-0 fw-400 fs-6 conatent-down">{{ (Auth::user()->email)??'' }}</h4>   
                        </div>
                    </div>
                    <ul class="pt-4">
                        <li>
                            <a class="dropdown-item editProfile conatent-down"
                        ...
                        @if(!session('impersonated_by'))
                        <li>
                            <button type="button" class="btn btn-primary dropdown-item conatent-down" data-bs-toggle="modal"
                        ...
                        @if(!session('impersonated_by'))
                            <li>
                                ...
                                <a class="dropdown-item conatent-down" href="#"
