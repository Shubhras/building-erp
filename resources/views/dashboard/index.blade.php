                    ...
                    <div class="row">
                        @if($modules['Invoices'] == true)
                            ...
                            <!-- href="{{ route('invoices.index') }}" -->
                                <a class="text-decoration-none" href="{{route('patients.index')}}">
                        ...
                        @endif
                            @if($modules['Payments'] == true)
                                ...
                                <div class="col-xxl-4 col-xl-4 col-sm-6 widget">
                                    <a class="text-decoration-none"  href="{{ route('incomeverify') }}">
                            ...
                            @if($modules['Advance Payments'] == true)
                                ...
                                <div class="col-xxl-4 col-xl-4 col-sm-6 widget">
                                    <a class="text-decoration-none" href="{{ route('idverifications') }}">
                ...
                {{--<div class="col-xxl-7 col-12 mb-7 mb-xxl-0">
                    <div class="card">
                        <div class="card-header pb-0 px-10">
                            <h3 class="mb-0" style="color: #0c266c;">
