            ...
            <div class="col-xxl-5 col-12">
                <div class="d-sm-flex align-items-center mb-5 mb-xxl-0 text-center text-sm-start">
                    ...
                    <div class="ms-0 ms-sm-10 mt-5 mt-sm-0">
                        <span class="badge bg-light-{{ $data->patientUser->status === 1 ? 'success' : 'danger' }} mb-2 active-button">{{ ($data->patientUser->status === 1) ? __('messages.common.active') : __('messages.common.de_active') }}</span>
                        <h2><a href="#" class="text-decoration-none table-font">{{ $data->patientUser->full_name }}</a></h2>
                        <span class="text-gray-600 fs-5">
                            <i class="fa-solid fa-envelope me-1" style="color:#0c266c;"></i>
                            <a href="mailto:{{ $data->patientUser->email }}"
                               class="text-gray-600 text-decoration-none fs-5 sub-heading" style="color:#0c266c;">
                                {{ $data->patientUser->email }}
                            </a>
                        </span>
                        <span class="d-flex align-items-start me-sm-5 mb-2 mt-2 text-gray-600 fs-5 justify-content-center justify-content-sm-center sub-heading">
...
<div class="mt-7 overflow-hidden">
    <ul class="nav nav-tabs mb-5 pb-1 overflow-auto flex-nowrap text-nowrap" id="myTab" role="tablist">
        <li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link active p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#poverview"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.overview') }}
            </button>
        </li>
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pcases"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.cases') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#padmissions"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.patient_admissions') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pappointments"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.appointments') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pbills"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.bills') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pinvoices"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.invoices') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pAdvancedPayments"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.advanced_payments') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pDocument"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                {{ __('messages.documents') }}
            </button>
        </li>--}}
        {{--<li class="nav-item position-relative me-7 mb-3" role="presentation">
            <button class="nav-link p-0 header-link" id="patients-tab" data-bs-toggle="tab" data-bs-target="#pVaccinated"
                    type="button" role="tab" aria-controls="patients" aria-selected="false">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.user.phone').':' }}</label>
                            <span class="fs-5 text-gray-800 conatent-down">{{ !empty($data->patientUser->phone) ? $data->patientUser->phone :__('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.user.gender').':' }}</label>
                            <span class="fs-5 text-gray-800 conatent-down">{{ ($data->patientUser->gender != 1) ? __('messages.user.male') : __('messages.user.female') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.user.blood_group').':' }}</label>
                            ...
                            @else
                                <span class="conatent-down">{{ __('messages.common.n/a')}}</span>
                            @endif
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.user.dob') }}</label>
                            <span class="fs-5 text-gray-800 conatent-down">{{ !empty($data->patientUser->dob) ? \Carbon\Carbon::parse($data->patientUser->dob)->translatedFormat('jS M, Y') : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.common.created_at').':' }}</label>
                            <span class="fs-5 text-gray-800 conatent-down">{{ !empty($data->patientUser->created_at) ? $data->patientUser->created_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                        <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                            <label for="name"
                                   class="pb-2 fs-5 text-gray-600 conatent-up">{{ __('messages.common.updated_at').':' }}</label>
                            <span class="fs-5 text-gray-800 conatent-down">{{ !empty($data->patientUser->updated_at) ? $data->patientUser->updated_at->diffForHumans() : __('messages.common.n/a') }}</span>
                        </div>
                    </div>
                </div>
            </div>
